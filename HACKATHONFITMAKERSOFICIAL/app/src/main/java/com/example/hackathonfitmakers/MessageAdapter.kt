...
/**
 * Adaptador para el Chat con la IA.
 * Diferencia entre mensajes enviados por el usuario (derecha) y recibidos (izquierda).
 */
class MessageAdapter(private val messages: List<Message>) : RecyclerView.Adapter<MessageAdapter.MessageViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MessageViewHolder, position: Int) {
        ...
        // Cambiamos el estilo según si es mensaje nuestro (User) o de la IA
        if (message.isUser) {
            // Usuario: Alineado a la derecha, fondo oscuro, texto blanco
            ...
            // IA: Alineado a la izquierda, fondo grisáceo, texto azul oscuro
            ...
            holder.nameText.text = "Asistente IA"
